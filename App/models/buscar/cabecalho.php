...
<div id="main-content" class="container">
  ...
  <h1 class="font-weight-light text-center mt-4 mb-0">Anúncios de Vagas</h1>

  <h3 class="font-weight-light text-center mt-4 mb-0">Veja as pessoas que estão com um lugar...</h3>

  <h4 class="font-weight-light text-center mt-4 mb-0">e encontre um <strong> lugar para morar </strong> </h4>
  <hr class="mt-2 mb-5">
  ...
  <div class="div_formulario" style="align-items: center; display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center;"> <!--Div formulario-->
